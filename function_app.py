...
def weatherapifunction(myTimer: func.TimerRequest) -> None:
    ...
    EVENT_HUB_NAMESPACE = "weather-streaming-namespace.servicebus.windows.net"

    # Use DefaultAzureCredential for manager iddentity authentication
    ...
    def fetch_weather_data():
        ...
        locations= ["Kodaikanal","Madurai","Chennai","Ooty","Coimbatore"]
        
        VAULT_URL = "https://kyv-weather-streaming.vault.azure.net/" # Replace with your Key Vault URL
        API_KEY_SECRET_NAME = "weatherapikey"  # Replace with the name of your secret in Key Vault
        ...
        for location in locations:
            ...
            forecast_weather = get_forecast_weather(base_url, weatherapikey, location, 4)
